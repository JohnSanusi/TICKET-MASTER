...
"[project]/node_modules/@prisma/client/runtime/library.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function Yo() {
    return $.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../");
}
var Nf = "libquery-engine";
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-darwin");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-darwin-arm64");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-debian-openssl-1.0.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-debian-openssl-1.1.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-debian-openssl-3.0.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-linux-static-x64");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-linux-static-arm64");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-rhel-openssl-1.0.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-rhel-openssl-1.1.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query-engine-rhel-openssl-3.0.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-darwin.dylib.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-darwin-arm64.dylib.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-debian-openssl-1.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-debian-openssl-1.1.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-debian-openssl-3.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-linux-arm64-openssl-1.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-linux-arm64-openssl-1.1.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-linux-arm64-openssl-3.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-linux-musl.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-linux-musl-openssl-3.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-rhel-openssl-1.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-rhel-openssl-1.1.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../libquery_engine-rhel-openssl-3.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime"), "../query_engine-windows.dll.node");
...
async function za(e, t) {
    ...
    let o = await nt(), s = t.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime/library.js").match(Yd()) === null, c = {
        searchedLocations: i,
...
async function Zd(engineType, config) {
    ...
    ("TURBOPACK compile-time value", "/ROOT/node_modules/@prisma/client/runtime/library.js").includes("resolveEnginePath") && searchLocations.push(Yo());
...
exports.Prisma.ClaimedSeatScalarFieldEnum = {
    id: 'id',
    eventId: 'eventId',
    seatRow: 'seatRow',
    seatNum: 'seatNum',
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "/home/zen/Downloads/event-platform-build/node_modules/@prisma/client",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/zen/Downloads/event-platform-build/prisma/schema.prisma"
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
        "schemaEnvPath": "../../../.env"
    ...
    "inlineSchema": "// This is your Prisma schema file,\n// learn more about it in the docs: https://pris.ly/d/prisma-schema\n\ngenerator client {\n  provider = \"prisma-client-js\"\n}\n\ndatasource db {\n  provider = \"sqlite\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel Event {\n  id           String        @id @default(cuid())\n  title        String\n  description  String\n  location     String\n  date         String\n  time         String\n  image        String?\n  seatMap      String        @default(\"[]\") // JSON array of seats\n  hasTimer     Boolean       @default(false)\n  eventDate    String? // YYYY-MM-DD format\n  eventTime    String? // HH:mm format\n  createdAt    DateTime      @default(now())\n  updatedAt    DateTime      @updatedAt\n  seats        Seat[]\n  claimedSeats ClaimedSeat[]\n}\n\nmodel Seat {\n  id        String   @id @default(cuid())\n  eventId   String\n  event     Event    @relation(fields: [eventId], references: [id], onDelete: Cascade)\n  row       String // A, B, C, etc.\n  seatNum   Int // 1, 2, 3, etc.\n  available Boolean  @default(true)\n  createdAt DateTime @default(now())\n\n  @@unique([eventId, row, seatNum])\n}\n\nmodel ClaimedSeat {\n  id        String   @id @default(cuid())\n  eventId   String\n  event     Event    @relation(fields: [eventId], references: [id], onDelete: Cascade)\n  seatRow   String\n  seatNum   Int\n  email     String\n  name      String\n  ticketId  String   @unique\n  createdAt DateTime @default(now())\n}\n",
    "inlineSchemaHash": "15674bdfeab6915af248897a8c141bbef02b6d4d6510625511277def99c14fa3",
    "copyEngine": true
};
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
config.dirname = ("TURBOPACK compile-time value", "/ROOT/node_modules/.prisma/client");
if (!fs.existsSync(path.join(("TURBOPACK compile-time value", "/ROOT/node_modules/.prisma/client"), 'schema.prisma'))) {
...
config.runtimeDataModel = JSON.parse("{\"models\":{\"Event\":{\"dbName\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"String\",\"default\":{\"name\":\"cuid\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"title\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"description\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"location\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"date\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"time\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"image\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"seatMap\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"String\",\"default\":\"[]\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"hasTimer\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"Boolean\",\"default\":false,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"eventDate\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"eventTime\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"updatedAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"DateTime\",\"isGenerated\":false,\"isUpdatedAt\":true},{\"name\":\"seats\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Seat\",\"relationName\":\"EventToSeat\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"claimedSeats\",\"kind\":\"object\",\"isList\":true,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"ClaimedSeat\",\"relationName\":\"ClaimedSeatToEvent\",\"relationFromFields\":[],\"relationToFields\":[],\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false},\"Seat\":{\"dbName\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"String\",\"default\":{\"name\":\"cuid\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"eventId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"event\",\"kind\":\"object\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Event\",\"relationName\":\"EventToSeat\",\"relationFromFields\":[\"eventId\"],\"relationToFields\":[\"id\"],\"relationOnDelete\":\"Cascade\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"row\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"seatNum\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"available\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"Boolean\",\"default\":true,\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[[\"eventId\",\"row\",\"seatNum\"]],\"uniqueIndexes\":[{\"name\":null,\"fields\":[\"eventId\",\"row\",\"seatNum\"]}],\"isGenerated\":false},\"ClaimedSeat\":{\"dbName\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"String\",\"default\":{\"name\":\"cuid\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"eventId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":true,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"event\",\"kind\":\"object\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Event\",\"relationName\":\"ClaimedSeatToEvent\",\"relationFromFields\":[\"eventId\"],\"relationToFields\":[\"id\"],\"relationOnDelete\":\"Cascade\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"seatRow\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"seatNum\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"Int\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"email\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"name\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"ticketId\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":true,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"createdAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false}},\"enums\":{},\"types\":{}}");
defineDmmfProperty(exports.Prisma, config.runtimeDataModel);
config.engineWasm = undefined;
const { warnEnvConflicts } = __turbopack_context__.r("[project]/node_modules/@prisma/client/runtime/library.js [app-route] (ecmascript)");
warnEnvConflicts({
...
path.join(("TURBOPACK compile-time value", "/ROOT/node_modules/.prisma/client"), "libquery_engine-debian-openssl-3.0.x.so.node");
path.join(process.cwd(), "node_modules/.prisma/client/libquery_engine-debian-openssl-3.0.x.so.node");
// file annotations for bundling tools to include these files
path.join(("TURBOPACK compile-time value", "/ROOT/node_modules/.prisma/client"), "schema.prisma");
path.join(process.cwd(), "node_modules/.prisma/client/schema.prisma");
}),
"[project]/node_modules/.prisma/client/default.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = {
    ...__turbopack_context__.r("[project]/node_modules/.prisma/client/index.js [app-route] (ecmascript)")
};
}),
"[project]/node_modules/@prisma/client/default.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

module.exports = {
    ...__turbopack_context__.r("[project]/node_modules/.prisma/client/default.js [app-route] (ecmascript)")
};
}),
...
//# sourceMappingURL=node_modules_42f944ed._.js.map