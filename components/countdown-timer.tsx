...
export function CountdownTimer({ eventDate, eventTime, label }: CountdownTimerProps) {
  ...
  return (
    <div className="bg-blue-600 text-white rounded-lg p-8 shadow-lg max-w-3xl mx-auto">
      ...
      <div className="flex justify-center gap-4 text-center flex-wrap">
        <div className="bg-blue-700 rounded-lg p-4 min-w-[80px] md:min-w-[100px]">
          <div className="text-3xl md:text-4xl font-bold font-mono">{String(timeRemaining.days).padStart(2, "0")}</div>
          <div className="text-xs uppercase tracking-wider text-blue-100 mt-2">Days</div>
        </div>
        <div className="bg-blue-700 rounded-lg p-4 min-w-[80px] md:min-w-[100px]">
          <div className="text-3xl md:text-4xl font-bold font-mono">{String(timeRemaining.hours).padStart(2, "0")}</div>
          <div className="text-xs uppercase tracking-wider text-blue-100 mt-2">Hours</div>
        </div>
        <div className="bg-blue-700 rounded-lg p-4 min-w-[80px] md:min-w-[100px]">
          <div className="text-3xl md:text-4xl font-bold font-mono">{String(timeRemaining.minutes).padStart(2, "0")}</div>
          <div className="text-xs uppercase tracking-wider text-blue-100 mt-2">Min</div>
        </div>
        <div className="bg-blue-700 rounded-lg p-4 min-w-[80px] md:min-w-[100px]">
          <div className="text-3xl md:text-4xl font-bold font-mono">{String(timeRemaining.seconds).padStart(2, "0")}</div>
