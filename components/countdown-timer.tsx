  ...
  return (
    <div className="bg-blue-600 text-white rounded-lg p-8 shadow-lg">
      ...
      <div className="grid grid-cols-4 gap-4 text-center">
        <div className="bg-blue-700 rounded-lg p-4 min-w-[80px]">
          <div className="text-3xl md:text-5xl font-bold font-mono">{String(timeRemaining.days).padStart(2, "0")}</div>
          <div className="text-xs uppercase tracking-wider text-blue-100 mt-2">Days</div>
        </div>
        <div className="bg-blue-700 rounded-lg p-4 min-w-[80px]">
          <div className="text-3xl md:text-5xl font-bold font-mono">{String(timeRemaining.hours).padStart(2, "0")}</div>
          <div className="text-xs uppercase tracking-wider text-blue-100 mt-2">Hours</div>
        </div>
        <div className="bg-blue-700 rounded-lg p-4 min-w-[80px]">
          <div className="text-3xl md:text-5xl font-bold font-mono">{String(timeRemaining.minutes).padStart(2, "0")}</div>
          <div className="text-xs uppercase tracking-wider text-blue-100 mt-2">Min</div>
        </div>
        <div className="bg-blue-700 rounded-lg p-4 min-w-[80px]">
          <div className="text-3xl md:text-5xl font-bold font-mono">{String(timeRemaining.seconds).padStart(2, "0")}</div>
